...
> **⚠️ 연령 기준 정정 (2026-09-20).** 이 문서가 말하는 "미성년자(만 19세 미만) 법정대리인 동의"는
> **오기였다.** 정의 v0.3 §6.3 은 "미성년자(**만 14세 미만 포함 가능성**)"라고 유보했고
> docs/006 §8-1 도 "만 14세 미만 포함"이다. 인용된 정책 §6 은 접근 통제 절이라 연령과 무관하다.
> 즉 **근거로 든 두 문서 어디에도 만 19 가 없다** — "미성년자"라는 낱말에 민법 성년 연령을 대입한
> 것으로 보인다. 법정대리인 동의의 실제 기준은 **만 14세**(개인정보 동의 경계)이며, 코드는
> 2026-09-20 에 그 축으로 정정됐다(`apps/web/lib/consent-gate.ts`).
> 만 14~18 은 본인 동의로 진행하되 보호자 고지를 권한다.
...
- ~~**미성년자(만 19세 미만) 학생은 본인 동의 + 법정대리인(보호자) 동의 둘 다 필수**~~ → **정정(2026-09-20): 만 14세 미만**이 기준이다(상단 배너). 만 14세 이상은 본인 동의로 진행한다.
